...
current_theme = 'dark'
# Функция для обновления стилей полей ввода в зависимости от темы
def update_input_styles(dark_mode: bool):
    # Цвет текста и фон
    text_color = '#ffffff' if dark_mode else '#000000'
    background_color = '#444444' if dark_mode else '#ffffff'
    # Собираем стиль
    style = f"""
        /* Базовые поля ввода */
        QLineEdit, QTextEdit,
        ...
        /* Сами элементы списка выпадающего QComboBox */
...
# Функция переключения темы и обновления стилей полей ввода
def toggle_theme():
    ...
    if current_theme == 'dark':
        ...
        current_theme = 'light'
        update_input_styles(dark_mode=False)
    else:
        apply_stylesheet(app, theme='dark_teal.xml')
        current_theme = 'dark'
        update_input_styles(dark_mode=True)
...
class LoginWindow(QWidget):
    def __init__(self):
        ...
        update_input_styles(dark_mode=(current_theme=='dark'))
